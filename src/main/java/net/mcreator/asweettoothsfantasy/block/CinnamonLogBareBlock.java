...
public class CinnamonLogBareBlock extends SweettoothFantasyModElements.ModElement {
	@ObjectHolder("sweettooth_fantasy:cinnamon_log_bare")
	public static final Block block = null;
	public CinnamonLogBareBlock(SweettoothFantasyModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cinnamon_log_bare");
		}
