...
import net.mcreator.asweettoothsfantasy.item.CinnamonBarkItem;
import net.mcreator.asweettoothsfantasy.block.CinnamonlogstrippedBlock;
import net.mcreator.asweettoothsfantasy.block.CinnamonLogBareBlock;
...
public class CinnamonlogstrippedOnBlockRightClickedProcedure extends SweettoothFantasyModElements.ModElement {
	public CinnamonlogstrippedOnBlockRightClickedProcedure(SweettoothFantasyModElements instance) {
		super(instance, 92);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem() instanceof AxeItem)
				&& (CinnamonlogstrippedBlock.block.getDefaultState().getBlock() == (world.getBlockState(new BlockPos((int) x, (int) y, (int) z)))
						.getBlock()))) {
			{
			...
			if (world instanceof World && !world.isRemote()) {
				ItemEntity entityToSpawn = new ItemEntity((World) world, x, y, z, new ItemStack(CinnamonBarkItem.block, (int) (1)));
			...
			if (((Cinnamon_Bark_Drops) <= 0.3)) {
				if (world instanceof World && !world.isRemote()) {
					ItemEntity entityToSpawn = new ItemEntity((World) world, (x + 0.5), (y + 0.5), (z + 0.5),
							new ItemStack(CinnamonBarkItem.block, (int) (1)));
					entityToSpawn.setPickupDelay((int) 10);
					world.addEntity(entityToSpawn);
				}
			}
