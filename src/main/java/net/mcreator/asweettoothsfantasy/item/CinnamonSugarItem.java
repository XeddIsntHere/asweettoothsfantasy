...
public class CinnamonSugarItem extends SweettoothFantasyModElements.ModElement {
	@ObjectHolder("sweettooth_fantasy:cinnamon_sugar")
	public static final Item block = null;
	public CinnamonSugarItem(SweettoothFantasyModElements instance) {
		super(instance, 96);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("cinnamon_sugar");
		}
