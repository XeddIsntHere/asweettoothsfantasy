...
public class CookedBaconItem extends SweettoothFantasyModElements.ModElement {
	@ObjectHolder("sweettooth_fantasy:cooked_bacon")
	public static final Item block = null;
	public CookedBaconItem(SweettoothFantasyModElements instance) {
		super(instance, 103);
	}
