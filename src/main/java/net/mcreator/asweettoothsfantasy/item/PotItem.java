...
public class PotItem extends SweettoothFantasyModElements.ModElement {
	@ObjectHolder("sweettooth_fantasy:pot")
	public static final Item block = null;
	public PotItem(SweettoothFantasyModElements instance) {
		super(instance, 143);
	}
