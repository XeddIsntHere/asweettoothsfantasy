...
public class MintleafItem extends SweettoothFantasyModElements.ModElement {
	@ObjectHolder("sweettooth_fantasy:mintleaf")
	public static final Item block = null;
	public MintleafItem(SweettoothFantasyModElements instance) {
		super(instance, 1);
	}
