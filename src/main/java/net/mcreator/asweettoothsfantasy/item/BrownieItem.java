...
public class BrownieItem extends SweettoothFantasyModElements.ModElement {
	@ObjectHolder("sweettooth_fantasy:brownie")
	public static final Item block = null;
	public BrownieItem(SweettoothFantasyModElements instance) {
		super(instance, 131);
	}
