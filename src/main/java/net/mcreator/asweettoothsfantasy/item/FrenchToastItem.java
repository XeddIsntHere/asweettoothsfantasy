...
public class FrenchToastItem extends SweettoothFantasyModElements.ModElement {
	@ObjectHolder("sweettooth_fantasy:raw_french_toast")
	public static final Item block = null;
	public FrenchToastItem(SweettoothFantasyModElements instance) {
		super(instance, 111);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("raw_french_toast");
		}
