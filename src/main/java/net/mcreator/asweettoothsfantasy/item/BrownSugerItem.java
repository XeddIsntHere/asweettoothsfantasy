...
public class BrownSugerItem extends SweettoothFantasyModElements.ModElement {
	@ObjectHolder("sweettooth_fantasy:brown_suger")
	public static final Item block = null;
	public BrownSugerItem(SweettoothFantasyModElements instance) {
		super(instance, 120);
	}
