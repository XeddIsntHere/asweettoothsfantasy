...
public class RawHoneySweetRollItem extends SweettoothFantasyModElements.ModElement {
	@ObjectHolder("sweettooth_fantasy:raw_honey_sweet_roll")
	public static final Item block = null;
	public RawHoneySweetRollItem(SweettoothFantasyModElements instance) {
		super(instance, 118);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("raw_honey_sweet_roll");
		}
