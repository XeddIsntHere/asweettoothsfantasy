...
public class RawBrownieItem extends SweettoothFantasyModElements.ModElement {
	@ObjectHolder("sweettooth_fantasy:raw_brownie")
	public static final Item block = null;
	public RawBrownieItem(SweettoothFantasyModElements instance) {
		super(instance, 135);
	}
