...
public class KnifeItem extends SweettoothFantasyModElements.ModElement {
	@ObjectHolder("sweettooth_fantasy:knife")
	public static final Item block = null;
	public KnifeItem(SweettoothFantasyModElements instance) {
		super(instance, 101);
	}
	...
	public void initElements() {
		...
		}, 3, -3f, new Item.Properties().group(ASweetToothsFantasyItemGroup.tab)) {
			@Override
