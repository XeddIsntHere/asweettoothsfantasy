...
public class WrappedChocolateCoinItem extends SweettoothFantasyModElements.ModElement {
	@ObjectHolder("sweettooth_fantasy:wrapped_chocolate_coin")
	public static final Item block = null;
	public WrappedChocolateCoinItem(SweettoothFantasyModElements instance) {
		super(instance, 21);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("wrapped_chocolate_coin");
		}
